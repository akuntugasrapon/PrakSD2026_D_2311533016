...
public final class Jam_2311533016 {
    ...
    // ---- Konstruktor / Kreator ----
    public Jam_2311533016(int h, int m, int s) {
        this.hh = h;
        this.mm = m;
        this.ss = s;
    }
    ...
    public static Jam_2311533016 fromSeconds(int total) {
        ...
        return new Jam_2311533016(h, m, s);
    }

    // ---- Perbandingan ----
    public int compareTo(Jam_2311533016 other) {
        return Integer.compare(this.toSeconds(), other.toSeconds());
    }

    public boolean equals(Object o) {
        if (!(o instanceof Jam_2311533016)) return false;
        Jam_2311533016 j = (Jam_2311533016) o;
